...
let Brand = class Brand {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, image: { required: true, type: () => String }, createdAt: { required: true, type: () => Date }, updateAt: { required: true, type: () => Date }, products: { required: true, type: () => [require("./product.entity").Product] } };
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Date)
], Brand.prototype, "updateAt", void 0);
__decorate([
    typeorm_1.OneToMany(() => product_entity_1.Product, (product) => product.brand),
