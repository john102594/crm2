...
exports.UpdatePurchaseOrderItemDto = exports.CreatePurchaseOrderItemDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
class CreatePurchaseOrderItemDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { quantity: { required: true, type: () => Number }, unit_cost: { required: true, type: () => Number }, productId: { required: true, type: () => Number } };
    }
}
__decorate([
...
class UpdatePurchaseOrderItemDto extends swagger_1.PartialType(CreatePurchaseOrderItemDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
