...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("../entities/purchase-order.entity").PurchaseOrder] }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: common_1.HttpStatus.ACCEPTED, type: require("../entities/purchase-order.entity").PurchaseOrder }),
