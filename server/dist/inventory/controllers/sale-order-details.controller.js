...
let SaleOrderDetailsController = class SaleOrderDetailsController {
...
__decorate([
    common_1.Get(),
    swagger_1.ApiOperation({ summary: 'List of saleOrderDetails' }),
    openapi.ApiResponse({ status: 200, type: [require("../entities/sale-order-detail.entity").SaleOrderDetail] }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: common_1.HttpStatus.ACCEPTED, type: require("../entities/sale-order-detail.entity").SaleOrderDetail }),
...
__decorate([
    common_1.Post(),
    openapi.ApiResponse({ status: 201, type: require("../entities/sale-Order.entity").SaleOrder }),
...
SaleOrderDetailsController = __decorate([
    swagger_1.ApiTags('saleOrderDetails'),
    common_1.Controller('saleOrderDetails'),
    __metadata("design:paramtypes", [sale_order_details_service_1.SaleOrderDetailsService])
], SaleOrderDetailsController);
exports.SaleOrderDetailsController = SaleOrderDetailsController;
