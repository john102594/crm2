...
__decorate([
    common_1.Get(),
    swagger_1.ApiOperation({ summary: 'List of purchaseorderdetails' }),
    openapi.ApiResponse({ status: 200, type: [require("../entities/purchase-order-detail.entity").PurchaseOrderDetail] }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: common_1.HttpStatus.ACCEPTED, type: require("../entities/purchase-order-detail.entity").PurchaseOrderDetail }),
...
__decorate([
    common_1.Post(),
    openapi.ApiResponse({ status: 201, type: require("../entities/purchase-order.entity").PurchaseOrder }),
...
PurchaseOrderDetailsController = __decorate([
    swagger_1.ApiTags('purchaseorderDetails'),
    common_1.Controller('purchaseorderdetails'),
