...
let PurchaseOrderDetailsService = exports.PurchaseOrderDetailsService = class PurchaseOrderDetailsService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async findAll() {
    ...
    async findOne(id) {
        const purchaseorderDetail = await this.prisma.purchaseOrderDetail.findUnique({
            where: { id },
        });
...
exports.PurchaseOrderDetailsService = PurchaseOrderDetailsService = __decorate([
